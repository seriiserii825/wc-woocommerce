<?php
/**
 * wc-woocommerce functions and definitions
 *
...
if ( ! function_exists( 'wc_woocommerce_setup' ) ) :
	...
	function wc_woocommerce_setup() {
		 ...
		 * If you're building a theme based on wc-woocommerce, use a find and replace
		 * to change 'wc-woocommerce' to the name of your theme in all the template files.
		 */
		...
		register_nav_menus(
			array(
				'menu-1' => esc_html__( 'Primary', 'wc-woocommerce' ),
			)
		);
		...
		add_theme_support(
			'custom-background',
			apply_filters(
				'wc_woocommerce_custom_background_args',
				array(
